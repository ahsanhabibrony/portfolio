 ...
 */
! function (t, e) {
	"object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("index.html")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e((t = t || self).bootstrap = {}, t.jQuery, t.Popper)
}(this, function (t, g, u) {
	"use strict";
...
var Autocare = function () {
	...
	var e = $(window).width(),
		...
		n = function () {
			...
			if (jQuery(".dzload").each(function () {
				...
				if (0 == $(".mo-left .header-nav").children("div").length) {
					...
					jQuery(".mo-left .header-nav").prepend(i), jQuery(".mo-left .header-nav .logo-header > a > img").attr("src", "images/logo.png"), jQuery(".mo-left.lw .header-nav .logo-header > a > img").attr("src", "images/logo-white.png")
				}
		...
		u = new Date;
	monthNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], u.setMonth(u.getMonth() + 1), u = u.getDate() + " " + monthNames[u.getMonth()] + " " + u.getFullYear();
	var c = function () {
	...
	return {
		init: function () {
			jQuery(".box-hover").on("mouseenter", function () {
				...
				}(), o(), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'),
				function (e) {
				...
				}(u), e > 768 && $(".content-scroll").length > 0 && $(".content-scroll").mCustomScrollbar({
					setWidth: !1,
					setHeight: !1,
					axis: "y"
				}), s(), $(".item-close").on("click", function () {
					$(this).closest(".cart-item").hide("500")
				}), $(".cart-btn").unbind().on("click", function () {
					$(".cart-list").slideToggle("slow")
				}), $(".full-height").css("height", $(window).height()), c(), jQuery(window).on("resize", function () {
					jQuery(".modal:visible").each(l), jQuery(".equal-wraper").length && r(".equal-wraper .equal-col"), a()
				}), jQuery(".modal").on("show.bs.modal", l), $("#lightgallery, .lightgallery").length > 0 && $("#lightgallery, .lightgallery").lightGallery({
					selector: ".check-km",
					loop: !0,
					thumbnail: !0,
...
jQuery(window).on("load", function () {
	...
	addSwitcher(), jQuery(".switch-btn").on("click", function () {
		...
		return jQuery(".skin").attr("href", "css/skin/skin-1.css"), jQuery(".logo-header img").attr("src", "images/logo.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-dark.png"), jQuery(".logo-header.logo-black img").attr("src", "images/logo-black.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo.png"), !1
	}), jQuery(".skin-2").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-header img").attr("src", "images/logo2.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-dark2.png"), jQuery(".logo-header.logo-black img").attr("src", "images/logo-black2.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark2.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black2.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo2.png"), !1
	}), jQuery(".skin-3").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-3.css"), jQuery(".logo-header img").attr("src", "images/logo3.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-dark3.png"), jQuery(".logo-header.logo-black img").attr("src", "images/logo-black3.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark3.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black3.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo3.png"), !1
	}), jQuery(".skin-4").on("click", function () {
		return jQuery(".skin").attr("href", "css/skin/skin-4.css"), jQuery(".logo-header img").attr("src", "images/logo4.png"), jQuery(".logo-header.dark img").attr("src", "images/logo-dark4.png"), jQuery(".logo-header.logo-black img").attr("src", "images/logo-black4.png"), jQuery(".logo-footer img").attr("src", "images/logo-dark4.png"), jQuery(".sidenav .logo-header img").attr("src", "images/logo-black4.png"), jQuery(".full-blog-dark .sidenav .logo-header img").attr("src", "images/logo4.png"), !1
